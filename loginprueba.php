<?php
	if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($data["Status"] == "404"){
            ...
            header('Location: adminprueba.php?sucu_id='.$data['Detalles']['0']['sucu_id']);
            // Supongamos que recuperas el valor de la base de datos y lo guardas en $valorGlobal
            $valorGlobal = $data['Detalles']['0']['usu_id'];
