...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(60, 10, utf8_decode('Fecha de Emisión'), 1, 0, 'C', 1);
      $this->Cell(60, 10, utf8_decode('Número de Mesa'), 1, 0, 'C', 1);
      $this->Cell(60, 10, utf8_decode('Monto total'), 1, 1, 'C', 1);
...
foreach($data["Detalles"] as $reporte_ventas):

$pdf->Cell(60, 10, $reporte_ventas["bol_fech_emision"], 1, 0, 'C', 0);
$pdf->Cell(60, 10, $reporte_ventas["depe_num_mesa"], 1, 0, 'C', 0);
$pdf->Cell(60, 10, $reporte_ventas["bol_monto_total"], 1, 1, 'C', 0);
// $pdf->Cell(35, 10, $reporte_ventas["pla_precio"], 1, 1, 'C', 0);
// $pdf->Cell(50, 10, $reporte_clientes["pla_precio"], 1, 1, 'C', 0);
// $pdf->Cell(25, 10, utf8_decode("total"), 1, 1, 'C', 0);

endforeach;

$pdf->Output('Reportes_Ventas.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
